...
- Name: flows/wallet.spec.ts >> Wallet Home Page >> Given an authenticated user >> When the page loads >> Then should show loading skeletons initially
- Location: e2e/flows/wallet.spec.ts:37:7
