...
- Name: flows/wallet.spec.ts >> Wallet Home Page >> Given an authenticated user >> When viewing the home page >> Then should display balance card
- Location: e2e/flows/wallet.spec.ts:19:7
