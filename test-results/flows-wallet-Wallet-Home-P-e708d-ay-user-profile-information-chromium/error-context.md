...
- Name: flows/wallet.spec.ts >> Wallet Home Page >> Given an authenticated user >> When viewing the home page >> Then should display user profile information
- Location: e2e/flows/wallet.spec.ts:13:7
